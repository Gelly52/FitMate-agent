package com.itgeo.fitmate.mcp.time;
...
public class DateTool {
    ...
    @Tool(description = "根据城市所在的时区id获取当前时间")
    ...
    public String getCurrentTime() {
        ...
        String currentTime = String.format("当前时间是：%s", LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
